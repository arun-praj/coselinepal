...
import { isKhalti, isManual, isStripe } from "@lib/constants"
...
const PaymentButton: React.FC<PaymentButtonProps> = ({
  ...
  switch (true) {
    ...
    case isKhalti(paymentSession?.provider_id):
      return (
        <KhaltiPaymentButton notReady={notReady} data-testid={dataTestId} />
      )
...
const KhaltiPaymentButton = ({ notReady }: { notReady: boolean }) => {
  const [submitting, setSubmitting] = useState(false)
  const [errorMessage, setErrorMessage] = useState<string | null>(null)
